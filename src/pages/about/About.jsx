    ...
    return (
        <div>
            ...
            <div className='container about-us'>
                <div className='row'>
                    <div className='col-lg-6 col-sm-12'>
                        <h2 className='pt-5 pb-2'>Organisation for Transforming African Communities</h2>
                        <p>
            ...
            <div className='team container pb-5'>
                <h2 className='text-center p-5'>Our Team</h2>
                <div className='row'>
            ...
            <div className='container partners'>
                <h2 className='p-2 text-center'>Our Partners</h2>
